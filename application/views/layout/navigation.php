                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li><a href="<?php echo base_url() ?>konfirmasi"><i class="ti-check-box"></i> <span class="span">Konfirmasi</span></a></li>
                            <li><a href="<?php echo base_url() ?>login/logout"><i class="ti-arrow-circle-left"></i> <span class="span">Keluar</span></a></li>
                        </ul>
                    </nav>
                </div>
            </div>
