    ...
    <div class="sales-report-area sales-style-two">
        ...
        <div class="container">
            ...
            <div class="text-over-image">
                ...
                <div class="mt-2 text-white" style="font-size: 18px; font-family: 'Comic Sans MS', cursive, sans-serif;">
        ...
        <div class="text-center mt-3">
            ...
            <a href="<?= base_url('tiket/download/pdf/' . $booking_id) ?>" class="btn btn-info m-1" style="font-family: 'Comic Sans MS', cursive, sans-serif; font-weight: bold; background: #ABFFFB; color: #000; border: 2px solid #000; border-radius: 15px;">PDF</a>
